...
Simplified RANS Equation : grad_y^+(U^+) - uv^+ = 1


#-----------------------------------------------------------------
Files
#-----------------------------------------------------------------
1. couette_bench_mark.py -- well posed problem computed U^+, uv^+ suppied
2. couette_bc_data_sparse.py  -- computes for sparse data
3. couette_bc_data_nonFic_sparse_data.py -- computes for sparse data
4. couette_bc_data_nonFic.py  - only boundary conditions applied
5. couette_bc_data.py - only boundary conditions applied
...
#-----------------------------------------------------------------
1. couette_bc_data_nonFic_sparse_data.py -- computes for sparse data
2. couette_bc_data_nonFic.py -- only boundary conditions applied
...
No Model 
#-----------------------------------------------------------------
1. couette_bc_data_sparse.py  -- computes for sparse data
2. couette_bc_data.py - only boundary conditions applied
